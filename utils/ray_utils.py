...
def pluecker(cfg):
    ...
    if 'voxel_size' in cfg:
        direction_multiplier = cfg.voxel_size

    if 'multiplier' in cfg:
        direction_multiplier *= cfg.multiplier
        moment_multiplier *= cfg.multiplier
    ...
    def param(rays):
        ...
        return torch.cat([rays_d * direction_multiplier, m * moment_multiplier], dim=-1)
